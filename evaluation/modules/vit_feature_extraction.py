...
class ViT_FeatureExtractor(nn.Module):
    def __init__(self, *, image_size, patch_size, dim, depth, heads, mlp_dim, channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0.):
        ...
        self.h_num_patches = image_height // patch_height
        self.w_num_patches = image_width // patch_width
    ...
    def forward(self, img):
        ...
        x = rearrange(x, 'b (h w) c -> b c h w', h=self.h_num_patches, w=self.w_num_patches) # (b,c,h,w)
